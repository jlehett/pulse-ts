 ...
 * import { TransportService } from '@pulse-ts/network';
 * import { createMemoryHub, MemoryTransport } from '@pulse-ts/network';
 * const world = new World();
 * const hub = createMemoryHub();
 * const svc = world.provideService(new TransportService());
 * svc.setTransport(new MemoryTransport(hub, 'a'));
 * await svc.connect();
 * svc.subscribe<string>('chat', (m) => console.log('chat', m));
 * svc.publish('chat', 'hello');
 * svc.flushOutgoing();
 */
