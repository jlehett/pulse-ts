...
export type PrefabFactory<N extends Node = Node> = (node: N, context: ThreeViewContext) => Object3D;
 ...
 */
export function threePrefab<N extends Node = Node>(factory: PrefabFactory<N>): ClassDecorator {
