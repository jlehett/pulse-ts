...
- [x] Camera shakes visibly on collision (small) and knockout (big)
- [x] KO flash is tinted in the scoring player's color
- [x] Brief dark fade during resetting phase smooths round transition
- [x] Confetti particle burst plays on match victory
- [x] All tests pass
...
- **2026-03-02**: Implementation complete — camera shake (CameraRigNode + LocalPlayerNode collision trigger), player-colored KO flash with resetting fade (KnockoutOverlayNode), and victory confetti (VictoryEffectNode + ArenaNode wiring). All 147 arena tests + 45 three tests pass. Lint clean.
